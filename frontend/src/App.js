    ...
    <div style={{display:"flex",height:"100vh",background:"#030710",fontFamily:M,color:"#8ba5be",overflow:"hidden"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @keyframes slideR{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}
      ...
      {/* ── TOAST ALERTS ── */}
      <div style={{position:"fixed",bottom:16,right:16,zIndex:9999,display:"flex",flexDirection:"column-reverse",gap:6,width:300}}>
        {alerts.map(a=>(
